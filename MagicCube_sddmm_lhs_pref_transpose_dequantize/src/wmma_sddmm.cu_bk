...
template <int Tile_K=32, int Tile_N=64, int VecLength=2>
    ...
    int vec_length)
{
    switch(vec_length){
        case 2:
            return wmmaSddmm_16b_template<1, 32, 64, 32, 8, 2>(m_vec, n, k, vec_length, row_indices, 
            	   row_offsets, column_indices, lhs_matrix, rhs_matrix, output_values);
	    break;
        case 4:
            return wmmaSddmm_16b_template<1, 32, 64, 32, 8, 4>(m_vec, n, k, vec_length, row_indices, 
            	   row_offsets, column_indices, lhs_matrix, rhs_matrix, output_values);
	    break;
        case 8:
