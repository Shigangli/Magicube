...
template <int Tile_K=64, int Tile_N=32, int VecLength=8>
    ...
    int* __restrict__ output_values)
{
    ...
    // Each int32 has 8 4-bit integers and double buffer
    ...
    int vec_length)
{
    switch(vec_length){
        case 2:
            return wmmaSddmm_4b_template<1, 64, 32, 32, 4, 2>(m_vec, n, k, row_indices, 
            	   row_offsets, column_indices, lhs_matrix, rhs_matrix, output_values);
	    break;
        case 4:
            return wmmaSddmm_4b_template<1, 64, 32, 32, 4, 4>(m_vec, n, k, row_indices, 
            	   row_offsets, column_indices, lhs_matrix, rhs_matrix, output_values);
	    break;
        case 8:
            return wmmaSddmm_4b_template<1, 64, 32, 32, 4, 8>(m_vec, n, k, row_indices, 
            	   row_offsets, column_indices, lhs_matrix, rhs_matrix, output_values);
	    break;
        default:
    ...
    int vec_length)
{
    switch(vec_length){
        case 2:
            return wmmaSddmm_8b_template<1, 64, 32, 32, 4, 2>(m_vec, n, k, row_indices, 
            	   row_offsets, column_indices, lhs_matrix, rhs_matrix, output_values);
	    break;
        case 4:
            return wmmaSddmm_8b_template<1, 64, 32, 32, 4, 4>(m_vec, n, k, row_indices, 
            	   row_offsets, column_indices, lhs_matrix, rhs_matrix, output_values);
	    break;
        case 8:
            return wmmaSddmm_8b_template<1, 64, 32, 32, 4, 8>(m_vec, n, k, row_indices, 
            	   row_offsets, column_indices, lhs_matrix, rhs_matrix, output_values);
	    break;
        default:
            printf("Unsupported Vector Length!\n");
    ...
    int vec_length)
{
    switch(vec_length){
        case 2:
            return wmmaSddmm_16b_template<1, 64, 32, 32, 4, 2>(m_vec, n, k, row_indices, 
            	   row_offsets, column_indices, lhs_matrix, rhs_matrix, output_values);
	    break;
        case 4:
            return wmmaSddmm_16b_template<1, 64, 32, 32, 4, 4>(m_vec, n, k, row_indices, 
            	   row_offsets, column_indices, lhs_matrix, rhs_matrix, output_values);
	    break;
        case 8:
            return wmmaSddmm_16b_template<1, 64, 32, 32, 4, 8>(m_vec, n, k, row_indices, 
            	   row_offsets, column_indices, lhs_matrix, rhs_matrix, output_values);
	    break;
        default:
            printf("Unsupported Vector Length!\n");
