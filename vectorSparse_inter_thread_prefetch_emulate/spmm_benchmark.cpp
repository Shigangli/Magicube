...
template <typename TypeA>
double compute_ref_integers(TypeA *A, int *B, int *ref_C, int M_GLOBAL, int K_GLOBAL, int N_GLOBAL, int A_BIT, int B_BIT, int vec_length, int *row_offsets, int *col_indices, int m_vec, int scaleA) {
    TypeA maskA = (TypeA)(power2n(A_BIT)-1); //0b0000000011111111 for 8 bits
    int maskB = power2n(B_BIT)-1; //0b0000000011111111 for 8 bits
