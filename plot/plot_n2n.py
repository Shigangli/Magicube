...
g = sns.barplot(data=n2n_a_data, x="S0.9,Seq_l=4096,num_h=4", y="Latency(ms)", hue="algs", palette="Blues_d", hue_order=order, ci=95, capsize=.1, errwidth=0.5)
#plt.xticks(rotation=20)
g.tick_params(labelsize=8)
g.set(ylim=(0, 25))
g.set_xlabel(" ", fontsize=8)
g.set_title('S0.9, Seq_len=4096, num_h=4')
