        ...
        __device__ __forceinline__ void TileMAC(int step){
	        ...
	        if(lane_id_ % 32 < ValuesBlockWidth){
	            ...
	            for(int i=0; i<Blocks; i++){
	                ...
	                lhs_fragment[i*2 + 0] = lhs_tile_[i*ValuesBlockWidth + lane_id_ % (ValuesBlockWidth/2)*2];
	                lhs_fragment[i*2 + 1] = lhs_tile_[i*ValuesBlockWidth + lane_id_ % (ValuesBlockWidth/2)*2 + 1];
	            }
	        }
